...
abbey	abadía
abbot	abad
abbr. (abbr. for abbreviation)	abreviatura
...
abeam	de través
abed	en cama
abend (abbr. for abnormal end)	finalización anormal
...
abhor (to -)	aborrecer
ABI (abbr. for application binary interface)	interfaz binaria de aplicaciones
...
abysmal	abismal
abyss	abismo
AC (abbr. for automatic computing)	cálculo automático
AC (abbr. for automatic computing)	computación automática
academic	académico
academically	académicamente
academician	académico
academy	academia
ACC (abbr. for accumulator)	acumulador
accede (to -)	acceder
...
accounting software	programas de contabilidad
accouter (to -)	equipar
...
acorn	bellota
acoustic	acústico
acoustic delay line	linea acústica de retardo
acoustic delay line	línea de retardo acústica
acoustics	acústica
ACPI (abbr. for advanced control power interface)	interfaz avanzada para el control de potencia
...
ACS (abbr. for automatic computing system)	sistema informático
ACSEs (abbr. for application common service elements)	elementos comunes de servicio de aplicación
act	acto
acting	acción
actinium	actinio
action	acción
...
actuary	escribano
actuate (to -)	actuar
ACU (abbr. for automatic calling unit)	unidad de llamada automática
acuity	agudeza
...
acutely	agudamente
acuteness	agudeza
A/D (abbr. for analog to digital)	analógico a digital
adage	proverbio
adagio	adagio
adamant	inexorable
...
address calculating unit	unidad de cálculo de direcciones
address	dirección
...
adornment	adorno
adorn (to -)	adornar
ADP (abbr. for automatic data processing)	procesamiento automático de datos
ADPE (abbr. for automatic data processing equipment)	equipo de proceso automático de datos
...
ADU (abbr. for automatic dialing unit)	marcador automático
adulate (to -)	adular
adulation	adulación
adult	adulto
...
advance	adelanto
advanced	avanzado
advanced program-to-program communications	comunicaciones en condiciones de igualdad
...
advocacy	abogacía
advocate	abogado
AED (abbr. for automatic engineering design)	diseño automático en ingeniería
AED (abbr. for automatic engineering design)	diseño de ingeniería automático
Aegean Sea	Mar Egeo
aegis	amparo
Aeneas	Eneas
...
AES (abbr. for application environment specification)	especificacion de entorno de aplicaciones
AES (abbr. for application environment specification)	especificación de entorno de aplicaciones
aesthetic	estético
aesthetics	estética
afar	lejos
...
aged	viejo
age	edad
ageism	discriminación contra los ancianos
ageless	eterno
agency	agencia
agenda	agenda
...
aground	varado
ahead	adelantado
AI (abbr. for artificial intelligence)	IA (abrev. de inteligencia artificial)
aid	ayuda
aide	ayudante
AIDS	SIDA
aileron	alerón
...
ALGOL (abbr. for algorithmic language)	ALGOL (abrev. inglesa de lenguaje basado en algoritmos)
algorithm	algoritmo
algorithmic process	proceso algorítmico
alias	alias
alibi	coartada
alienable	alienable
alienate (to -)	alienar
...
allocation	reparto
allocation technique	técnica de adjudicación
allocation technique	técnica de asignación
allotment	reparto
allot (to -)	repartir
allowable	aceptable
allowance	concesión
...
alphanumeric display unit	display alfanumérico
alpha test	prueba alfa
alpine	alpino
Alps	Alpes
already	ya
Alsace	Alsacia
...
AM (abbr. for amplitude modulation)	AM (abrev. inglesa de modulación de amplitud)
amalgam	amalgama
...
analitical quartz lamp	lámpara analítica de cuarzo
analitical sampling	toma de pruebas analíticas
...
ancient	antiguo
ancillary	auxiliar
ancillary equipment	equipo ancilario
...
A (note)	la
another	otro
answer-only modem	modem de solo respuesta
answer-only modem	modem solo respuesta
answer	respuesta
...
aorta	aorta
AP (abbr. for array processor)	procesador de matrices
AP (abbr. for automatic programming)	programación automática
apart	aparte
apartheid	apartheid
...
aperitif	aperitivo
aperture	abertura
aperture time	tiempo de apertura
apex	ápice
aphid	áfido
aphorism	aforismo
aphrodisiac	afrodisíaco
API (abbr. for application program interface)	API (abrev. inglesa de interfaz para programas de aplicación)
apiary	colmenar
apiece	cada uno
APL (abbr. for A Programming Language)	APL (lenguaje de programación -)
aplomb	aplomo
apocryphal	apócrifo
apogee	apogeo
...
APPC (abbr. for advanced program-to-program communications)	comunicaciones en condiciones de igualdad
appeal	apelación
...
application common service elements	elementos comunes de servicio de aplicación
application engineer	ingeniero de sistemas
application (form)	instancia
application form	solicitud (impreso de -)
application	programa
application service elements	elementos de servicio de aplicación
application	solicitud
applications package	paquete de aplicación
applications package	programa de aplicación
applications programmer	programador de aplicaciones
applied	aplicado
apply (to -)	aplicar
apply (to -)	solicitar
...
apropos	pertinente
apse	ábside
APT (abbr. for automatic programming tools)	herramientas de programación automática
APT (abbr. for automatic programming tools)	herramientas de programación automática)
apt	apropiado
aptitude	aptitud
aptness	aptitud
...
archive	archivo
archived file	documento comprimido
archive site	lugar de archivo
archive (to -)	archivar
archivist	archivero
archway	entrada en forma de arco
ARCNet (abbr. for Attached Resource Computer Network)	red ARCNet
arctic	ártico
Arctic	Ártico
ardent	ardiente
ardor	ardor
...
arithmetic function	función aritmética
arithmetics	aritmética
arithmetic shift	desplazamiento aritmético
arithmetic statement	sentencia aritmética
arithmetic unit	unidad aritmética
Arizona	Arizona
Arkansas	Arkansas
ark	arca
armada	armada
...
around	alrededor de
arouse (to -)	despertar
ARP (abbr. for automatic receiver program)	programa receptor automático
ARQ (abbr. for automatic request)	demanda automática
...
array	formación
array processor	procesador de matrices
array (to -)	formar
arrear	atrasos
arrest	arresto
arresting	notable
...
arteriosclerosis dementia	demencia arteriosclerótica
artery	arteria
artful	ingenioso
...
artless	natural
ASAP (abbr. for as soon as possible)	lo antes posible
asbestos	asbesto
...
ASCII (abbr. for American Standard Code for Information Interchange)	ASCII (abrev. inglesa de código estándar para el intercambio de información)
ASCII (abbr. for American Standard Code for Information Interchange)	ASCII (abrev. inglesa de Estándar Americano de Codificación para el intercambio de información)
as	como
ascribe (to -)	atribuir
ascription	atribución
asepsis	asepsia
aseptic	aséptico
ASEs (abbr. for application service elements)	elementos de servicio de aplicación
asexual	asexual
ashamed	avergonzado
ash	ceniza
ashen	ceniciento
...
ask (to -)	preguntar
asleep	dormido
ASM (abbr. for assembler)	ensamblador
ASN (abbr. for autonomous system number)	número de sistema autónomo
asparagus	espárrago
aspect	aspecto
aspen	álamo
asperity	aspereza
...
aspirin	aspirina
aspiring	ambicioso
ASR (abbr. for automatic send and receive)	transmisión automática
ASR (abbr. for automatic send and receive)	transmisión-recepción automática
assailant	atacante
assail (to -)	asaltar
ass	asno
assassin	asesino
...
asymmetry	asimetría
async (abbr. for asynchronous)	asíncrono
asynchronous transmission	transmisión asíncrona
at	a
AT (abbr. for advanced technology)	tecnología avanzada
at (@)	arroba
ATE (abbr. for automatic test equipment)	equipo de prueba automático
atheism	ateísmo
atheist	ateo
Athenian	ateniense
Athens	Atenas
...
Atlantic (Ocean)	Atlántico (Océano -)
atlas	atlas
at least	por lo menos
ATM (abbr. for asynchronous transfer mode)	ATM (abrev. inglesa de modo de transferencia asíncrona)
...
atrophy	atrofia
atropine	atropina
ATS (abbr. for administrative terminal system)	sistema de terminal administrativo
Attached Resource Computer Network	ARCNet
attachment	adjunto
attachment unit interface	conexión de unidad de interfaz
attach (to -)	adherir
attach (to -)	adjuntar
attach (to -)	atar
attach (to -)	unir
...
attune	armonizar
atypical	atípico
AU (abbr. for arithmetic unit)	UA (abrev. de unidad aritmética)
...
audible	audible
audience	público
audio teleconferencing	audioteleconferencia
...
August	agosto
august	augusto
AUI (abbr. for attachment unit interface)	conexión de unidad de interfaz
a	un
aunt	tía
AUP (abbr. for acceptable use policy)	política de uso aceptable
aural	auditivo
...
author	autor
authoring language	lenguaje autor
authoring language	lenguaje de componer
authoring system	sistema autor
authoring system	sistema de autoría
authoring system	sistema de componer
...
auto	automático
autocode	autocódigo
autodecrementing	autodecremento
auto-dial	marcado automático
autoimmune disease	enfermedad autoinmune
autoincrementing	autoincremento
automatic computing	cálculo automático
automatic computing	computación automática
automatic programming	programación automática
automatic scroller	enrollamiento automático
automatic shutdown	apagado automático
automation	automatización
automatism	automatismo
autonomic	autónomo
autonomous system number	número de sistema autónomo
...
badminton	bádminton
badness	maldad
Baetic Cordillera	Sistema Penibético
baffle	confusión
...
BER (abbr. for bit error rate)	tasa de bits erróneos
berate	riña
bereaved	privado
...
bestowal	dádiva
bestow (to -)	dar
beta-adrenergic agonist	agonistas beta-adrenérgicos
bet	apuesta
...
biped	bípedo
biplane	biplano
BIPS (abbr. for billion of instructions per second)	miles de millones de instrucciones por segundo
birch	abedul
birdlime	liga (de cazar pajaros)
birdlime	liga (de cazar pájaros)
bird	pájaro
birthday	cumpleaños
...
Biscay	Vizcaya
biscuit	bizcocho
B-ISDN (abbr. for broadband ISDN)	RDSI de banda ancha
...
blood drawing and transfusion needle	aguja para la toma y transfusión de sangre
blood examination	examen del cuadro hemático
blood flow	flujo sanguíneo
bloodhound	sabueso
bloodless	pálido
blood pressure control unit	aparato para vigilar la presión sanguínea
blood pressure monitor	aparato para vigilar la presión sanguínea
...
boo (to -)	abuchear
BOOTP (abbr. for bootstrap protocol)	protocolo de arranque-asignación
bootstrap protocol	protocolo de arranque-asignación
boot (to -)	arrancar
...
bracelet	pulsera
braces	tirantes
brachial biceps	bíceps branquial
...
bridge	puente
bridgeware	programa de transición
bridging software	programa de transición
bridle	brida
briefcase	cartera
briefcase computer	ordenador de maletín
brief	informe
briefing	sesión
...
browser	navegador
browser	programa de visualización
browse (to -)	hojear
browse (to -)	ramonear
...
bubble sort	ordenación con el método de la burbuja
...
byte (by eight)	byte (unidad informática equivalente generalmente a 8 bits)
byte (by eight)	octeto
byte-code	código intermedio
byte-code	código J (en el lenguaje Java)
...
cacophony	cacofonía
cactus	cacto
CAD (abbr. for computer aided design)	CAD (abrev. inglesa de diseño asistido por ordenador)
cadaver	cadáver
...
cad	sinvergüenza
caducity	caducidad
CAE (abbr. for computer aided engineering)	CAE (abrev. inglesa de ingeniería asistida por ordenador)
cafe	café
cafe	cafés
cafeteria	cafetería
caffeine	cafeína
...
Calvary	calvario
calyx	cáliz
CAM (abbr. for computer aided manufacturing)	CAM (abrev. inglesa de fabricación asistida por ordenador)
...
can	lata
canned	enlatado
canned software	programa estándar
canner	envasador
cannery	fábrica de conservas
cannibal	caníbal
cannibalism	canibalismo
cannonade	cañoneo
cannonball	bala de can
...
capsize (to -)	volcar
caps lock (abbr. for capitals lock)	bloqueo de mayúsculas
...
carcinoma	carcinoma
car	coche
cardan coupling	acoplamiento cardán
cardfile	fichero
cardia	cardias
cardiac	cardiaco
cardiac	cardíaco
...
carrier sense multiple access	acceso de portadora de múltiple sentido
...
Central Sierras (in Spain)	Sistema Central (en España)
...
ceremony	ceremonia
CERN (abbr. for Conseil Europeen pour la Recherche Nucleaire)	CERN (abrev. francesa de Consejo Europeo para la Investigación Nuclear)
certain	cierto
...
cessation	cese
cession	cesión
CGA (abbr. for color graphics adapter)	adaptador de gráficos a color
CGI (abbr. for common gateway interface)	CGI (abrev. inglesa de interfaz común de pasarela)
chafe	rozadura
chaffinch	pinzón
...
click (to -)	clicar (FAM)
click (to -)	hacer clic
click (to -)	pulsar (la tecla del ratón para marcar)
clientele	clientela
...
cluster	racimo
clutter	desorden
CMIP (abbr. for common management information protocol)	protocolo de información
CMIP (abbr. for common management information protocol)	protocolo de información común de gestión
CMIS (abbr. for common management information services)	servicios de información
CMIS (abbr. for common management information services)	servicios de información común de gestión
CNI (abbr. for Coalition for Networked Information)	CNI (abrev. inglesa de coalición para la información a través de redes)
CNI (abbr. for Coalition for Networked Information)	CNI (abrev. inglesa de coalición para la información de redes)
C (note)	do
CNS (abbr. for connection-oriented network service)	servicio de red orientado a la conexión
coach	coche
...
coercion	coerción
coercive	coercitivo
Coeur de Lion (Richard -)	Corazón de León (Ricardo -)
...
coke	cola
cola	cola
colagenous fiber	fibra colágena
colander	colador
...
Columbia	Columbia
columbine	aguileña
Columbus (Cristopher -)	Colon (Cristobal -)
...
command-driven software	programa gobernado por órdenes
...
common management information protocol	protocolo de información común
common management information protocol	protocolo de información común de gestión
common management information services	servicios de información común
common management information services	servicios de información común de gestión
...
comprehension (UK)	ejercicio de comprensión
...
comprehensive school (UK)	instituto de segunda enseñanza para alumnos de cualquier aptitud
comprehensive (UK)	instituto de segunda enseñanza para alumnos de cualquier aptitud
comprehensive (UK)	relativo al sistema educativo en el cual no se separa a los educandos según su nivel de aptitud
compress	compresa
compressed	comprimido
compressed serial line protocol	protocolo de línea serie comprimido
...
computer animation	animación por ordenador
...
computing power	potencia de cálculo
comrade	camarada
...
condensed printing	impresión comprimida
...
connection	conexión
connection-oriented network service	servicio de red orientado a la conexión
...
context	contexto
context-free grammar	gramática independiente del contexto
...
crack a code (to -)	romper un código
crack	crujido
cracker	crácker
cracker	galleta salada
cracker	intruso (en un sistema informático)
...
CRT (abbr. for cathode ray tube)	TRC (abrev. de tubo de rayos catódicos)
crucial	crucial
crucible	crisol
crucifix	crucifijo
...
cry (to -)	llorar
CSLIP (abbr. for compressed serial line protocol)	protocolo de línea serie comprimido
CSMA (abbr. for carrier sense multiple access)	acceso múltiple por detección de portadora
...
cuttlefish	sepia
cut (to -)	cortar
CWIS (abbr. for Campus Wide Information System)	sistema de información universitario
cyanide	cianuro
...
darning	zurcido
darn (to -)	zurcir
DARPA (abbr. for Defense Advanced Research Projects Agency)	DARPA (abrev. inglesa de Agencia del Departamento de Defensa para proyectos de investigación avanzados)
dart	dardo
dash	arremetida
dash	guión
dashing	enérgico
dastardly	cobarde
DATACOM (abbr. for data communications)	comunicación de datos
data communications	comunicación de datos
data diddling	falsificación de datos
data encryption standard	algoritmo de encriptación estándar
datagram	datagrama
data highway	autopista de la información
...
DCE (abbr. for data terminal-circuit equipment)	equipo terminal del circuito de datos
deacon	diácono
deaconess	diaconisa
...
demo (abbr. for demonstration)	demostración
...
derrick	grúa
DES (abbr. for data encryption standard)	algoritmo de encriptación estándar
...
dialog	diálogo
dialogue	diálogo
dialup	conexión por linea conmutada
...
digital to analog	digital-analógico
digit	cifra
...
digress (to -)	divagar
dig (to -)	excavar
dig up (to -)	arrancar (un árbol o una mata)
dihedral	diedro
dike	dique
dilapidated	ruinoso
...
dip	zambullida
direct-connect modem	conexión directa al modem
direct-connect modem	módem de conexión directa
direct	directo
...
dizzy	vertiginoso
D (note)	re
DNS (abbr. for domain name system)	DNS (abrev. inglesa de sistema de nombres de dominio)
docile	dócil
dock	andén
docket	minuta
doctoral	doctoral
...
dove	paloma
Dover sole	lenguado
dovetail (to -)	ensamblar a cola de milano (en carpintería)
dowager	viuda
dowdy	desaliñado
dowel	clavija
down	abajo
...
downright	claro
downstairs	de abajo
downtime	tiempo de inactividad (debido a una avería)
...
dry	seco
dry (to -)	secar
DSP (abbr. for digital signal processor)	procesador digital de señal
DSS (abbr. for decision support system)	sistema de apoyo a la decisión
DTCE (abbr. for data terminal-circuit equipment)	equipo terminal del circuito de datos
...
DTP (abbr. for desktop publishing)	DTP (autoedición)
DTR (abbr. for data transfer ready)	DTR (abrev. inglesa de reparado para transmitir datos)
DTR (abbr. for data transfer ready)	DTR (pabrev. inglesa de preparado para transmitir datos)
dual	dual
...
DVB (abbr. for digital video broadcast)	vídeo digital para emisión
dwarf	enano
dweller	morador
dwelling	morada
dwellings	vivienda
...
easy	fácil
easy wearing	desenfadado
eatable	comestible
eat (to -)	comer
eaves	aleros
eavesdrop (to -)	escuchar indiscretamente
ebb (to -)	menguar (la marea)
ebone	red troncal europea
ebony	ébano
eccentric	excéntrico
eccentric	extravagante
eccentricity	excentricidad
ecclesiastical	eclesiástico
ecclesiastic	eclesiástico
ECG (abbrev. for electrocardiogram)	ECG (abrev. de electrocardiograma)
ECG electrode	electrodo para electrocardiograma
ECG monitoring	control de electrocardiograma
ECG waveform	onda del electrocardiograma
echelon	escalón
...
eczema	eccema
ED (abbr. for end delimiter)	final de trama
eddy	remanso
eddy	remolino
edema	edema
edge	borde
...
edgy	inquieto
edgy	nervioso
EDI (abbr. for Electronic Data Interchange)	EDI (abrev. inglesa de intercambio electrónico de datos)
edible	comestible
edible crab	buey
edict	decreto
...
edit (to -)	revisar
EDP (abbr. for electronic data processing)	proceso electrónico de datos
educated	educado
educate (to -)	educar
educational	educativo
education	educación (& enseñanza)
education	enseñanza
educator	educador
eel	anguila
eel-pout	lota de río
eerie	asustadizo
efface (to -)	borrar
effect	efecto
effective	eficaz
...
elapse (to -)	transcurrir
elastic cartilagenous tissue	tejido cartilaginoso elástico
elastic	elástico
...
electric ray	tembladera
electrification	electrificación
electrify (to -)	electrizar
...
electrocute (to -)	electrocutar
electrocution	electrocución
electrode	electrodo
electroencephalograph	electroencefalógrafo
...
embedded system	sistema insertado
embed (to -)	empotrar
...
emperor	emperador
emphasis	énfasis
emphasize	dar énfasis
emphasize (to -)	recalcar
emphasize (to -)	resaltar
emphasize (to -)	subrayar
emphatic	enfático
empire	imperio
empirical	empírico
empiric	empírico
...
endocrine	endocrino
end of file	final de fichero
endogenous depression	depresión endógena
endogenous depression	hipotimia
endogenous	endógeno
...
endowment	donación
endow (to -)	donar
end-plate	terminación en forma de disco
...
enforce (to -)	imponer
enforce (to -)	obligar
enfranchise	conceder derechos políticos
engagement	obligación
engage (to -)	comprometer
engaging	atractivo
...
enliven (to -)	avivar
enmity	enemistad
ennoble (to -)	ennoblecer
enormity	enormidad
enormous	enorme
E (note)	mi
enough	bastante
enqueue (to -)	poner en la cola
enquire (to -)	inquirir
enquiry	pregunta
enrage (to -)	enfurecerse
enrapture (to -)	arrebatar
enrich (to -)	enriquecerse
enrollment	matriculación
enroll (to -)	alistar
enroll (to -)	empadronar
enroll (to -)	enrolar
enroll (to -)	enrollar
ensemble	conjunto
enshrine (to -)	encerrar
ensign	bandera
enslavement	esclavitud
enslave (to -)	esclavizar
ensnare (to -)	coger en una trampa
ensue (to -)	suceder
ensure (to -)	asegurar
ensures	asegura
entail	vinculación
...
entertainment	función
entertain (to -)	entretener
enter (to -)	entrar
enter (to -)	introducir (datos)
enthrall (to -)	esclavizar
...
entrench (to -)	atrincherarse
entrepreneur	empresario
entrust (to -)	confiar
entry	entrada
entwine (to -)	entrelazar
enumerate (to -)	enumerar
enumeration	enumeración
enunciate (to -)	enunciar
enunciation	enunciado
envelopment	envoltura
envelop (to -)	envolver
enviable	envidiable
envious	envidioso
...
environs	contorno
envisage (to -)	mirar a la cara
envoy (to -)	enviar
envy (to -)	envidiar
enzootic	enzótico
enzyme	encima
EOF (abbr. for end of file)	final de fichero
eon	eón
ephemeral	efímero
epic	épico
epicure	epicúreo
...
epidermis	epidermis
epidermoid	epidermoide
epidymis	epidídimo
epigastrium	epigástrico
...
erosion	corrosión
erosion	erosión
erosive gastritis	gastritis erosiva
erotic	erótico
errand	mandado
errant	errante
erratic	errático
...
esophagic carcinoma	carcinoma esofágico
esophagus	esófago
esoteric	esotérico
especial	especial
...
Estonia	Estonia
estrange (to -)	extrañar
Estremadura	Extremadura
estrogen	estrógeno
estuary	estuario
etching	grabado
etch (to -)	grabar al agua fuerte
eternal	eterno
...
exhibitor	expositor
exhibit (to -)	exponer
exhilarate (to -)	alegrar
exhilaration	alegría
...
e-zine (abbr. for electronic magazine)	revista electrónica
fabled	legendario
fable	fábula
fabricate	fabricar
...
facilities (plural)	instalaciones (plural)
facilities (plural)	medios (plural)
facility	facilidad
...
faction	facción
factor	factor
factorize (to -)	descomponer en factores
factory	fábrica
factual	verdadero
faculty	facultad
fade (to -)	marchitarse
...
fan (to -)	ventilar
fan	ventilador
FAQ (abbr. for frequently asked questions)	preguntas más frecuentes
farad	faradio
faraway	lejano
farce	farsa
farcical	burlesco
...
farmland	campiña
farmstead	granja
farm track	camino vecinal
farmworker	bracero
farmworker	obrero agrícola
farmyard	corral
farmyard	patio de la granja
farrier	herrero
farsighted	perspicaz
...
fasting	ayuno
fast	rápido
FAT (abbr. for file allocation table)	FAT (abrev. inglesa de tabla de asignación de archivos)
fatality	fatalidad
fatally	fatalmente
fate	destino
fated	predestinado
...
fax (to -)	pasar por fax
faze (to -)	desconcertar
FDD (floppy disk drive)	FDD (controladora de disco flexible)
FDDI (abbr. for fiber digital device interface)	dispositivo de interfaz de fibra digital
fear	aprensión
fearful	aprensivo
fearful	temeroso
fearless	intrépido
...
federate (to -)	federarse
federation	federación
feeble	débil
feebleness	debilidad
feedback circuit	circuito de realimentación
feeding	alimentación
feed (to -)	alimentar
feeler	antena (de insectos)
...
few	pocos
fiasco	fracaso
fiber digital device interface	dispositivo de interfaz de fibra digital
fiber	fibra
fib	mentirijilla
fibre	fibra
fibres	fibras
fibril	fibrilla
fibrocartilagenous tissue	tejido cartilaginoso fibroso
fibrous	fibroso
fibrous membrane	membrana fibrosa
fibrous muff	manguito fibroso
fibrous pad	almohadilla fibrosa
...
fictitious	ficticio
fiddler	violinista
fiddle (to -)	hacer trampa
fiddle (to -)	trampear
fiddle	violín
fiddling	insignificante
fidelity	fidelidad
fidget (to -)	estar inquieto
fidgety	inquieto
fiefdom	dominio
fiefdom	feudo
fiefdom	reducto
...
figured	figurado
figure	figura
figure of eight (knot)	nudo de ocho
figurine	estatuilla
filbert	avellano
filch (to -)	hurtar
...
file deletion	borrado de archivos
file	ficha
file	fichero
file	lima
...
fit (to -)	ajustar
five	cinco
five-part forms	original y 4 copias (formulario con -)
fixation	fijación
fixed	fijo
...
flare	bengala
flared	acampanado
flashback	retrospectiva (escena -)
flashing	destello
flashlight	linterna eléctrica
flash	llamarada
flash (to -)	lanzar destellos
flash (to -)	parpadear
flashy	relumbrante
flask	frasco
flat	apartamento
flatbed plotter	trazador plano
flat	bemol
flatcar	vagón de plataforma
flat	llano
flatness	llanura
flat	plano
flattening	favorecedor
flatten (to -)	aplanar
flatterer	lisonjero
flatter (to -)	adular
flattery	lisonja
...
fluke	platija
flummox (to -)	asombrar
flummox (to -)	confundir
flummox (to -)	desconcertar
flunk	fracaso
fluorescent endoscope	endoscopio de luz fría
fluorescent	fluorescente
fluoroscope	fluoroscopio
flurry	agitación
flush right	alineación por la derecha
flush	rubor
flush	sofoco
flush (to -)	enrojecer
flush (to -)	ruborizarse
flush (to -)	vaciar
fluster	agitación
flute	flauta
flutter	vibración
...
foil	lamina
foist (to -)	colar algo
foist (to -)	encajar algo con engaño a uno
fold	doblar
folder	carpeta
folding	plegado
fold	pliegue
...
font cartridge	cartucho de tipos de letra
font	fuente
font	tipo (de letra)
food	comestibles
food	comida
...
foolish	tonto
fool	necio
foolproof	seguro (contra errores de manejo)
...
ford	vado
forearm	antebrazo
forebears (plural)	antepasados (plural)
...
foreclose (to -)	extinguir el derecho de redimir una hipoteca
...
form feed	alimentación de página
form	forma
form	formulario
...
fornicate (to -)	fornicar
fornication	fornicación
for	por
forsake (to -)	desamparar
fort	fuerte
forth	adelante
...
forward	avanzado
forward	delante
forwardness	progreso
forwards	adelante
forward (to -)	pasar
forward (to -)	redirigir
forward (to -)	reenviar
forward (to -)	retransmitir
fossil	fósil
fossilization	fosilización
fossilize (to -)	fosilizarse
foster	adoptivo
foul	falta
foul (# food)	estropeado
foul	sucio
...
free	gratis
free	gratuito
freehand (drawing)	a pulso (dibujo -)
free	libre
freely	libremente
freeman	hombre libre
freenet	red libre
freeware	programas de dominio público
freeware	programas de libre uso
freeze	helada
freezer	congelador
freeze (to -)	congelar
freeze (to -)	helar
...
FS (abbr. for frame status)	estado de la trama
FTAM (abbr. for file transfer, access and management)	transferencia, acceso y gestión de ficheros
fuck	echar un polvo
fucking	condenado
fucking	jodido
fucking	maldito
...
fuzzy	velloso
FYI (abbr. for for your information)	para su información
gabardine	gabardina
gabble	charla
gable	aguilón
gab	palique
...
garden	jardín
garfish	aguja
gargantuan kludge	armatoste gigante
gargle	gargarismo
gargoyle	gárgola
garish	chillon
garland	guirnalda
...
garnish	guarnición
garrison	guarnición
garrulity	garrulidad
garrulous	garrulo
garter	liga
gas chromatography	cromatografía gaseosa
gas discharge display	display de descarga gaseosa
gas	gas
gas	gasolina
gash	cuchillada
gasoline	gasolina
...
gaudiness	pompa
gaudy	ostentoso
gauge	instrumento (de medida)
gauge (to -)	calibrar
gauge (to -)	medir
gaunt	flaco
gauntlet	guantelete
gauze	gasa
gavel	martillo (del juez)
gawky	torpe
gay	alegre
gaze	mirada
gazette	gaceta
Gb (gigabit)	Gb (gigabit, unidad equivalente a 1.000.000.000 de bits)
GB (gigabyte)	GB (gigabyte, unidad equivalente a 1.000.000.000 de bytes)
gearing	engranaje
gearing	reductor
gear	marcha
gears	reductor
...
generalize (to -)	generalizar
generally	generalmente
general practice	consulta médica (privada)
...
germinate (to -)	germinar
germination	germinación
gerund	gerundio
gestation	gestación
gesticulate (to -)	gesticular
...
geyser	géiser
G (giga)	G (giga, prefijo griego correspondiente a 1.000.000.000)
ghastly	horrible
ghetto	gueto
ghost	fantasma
ghostly	fantasmal
...
gibbon	gibón
gibe	burla
GIF (abbr. for graphics interchange format)	GIF (abrev. inglesa de formato gráfico de intercambio)
gifted	dotado
gift	regalo
gigabit	gigabit (unidad equivalente a mil millones de bits)
gigabyte	gigabyte (unidad equivalente a mil millones de bytes)
gigantic	gigantesco
gig	calesa
giggle	risita
GII (abbr. for global information infrastructure)	GII (abrev. inglesa de infraestructura global de información)
gilding	dorado
gild (to -)	dorar
gill	agalla
gilt	dorado
...
giver	dador
give (to -)	dar
GIX (abbr. for global Internet exchange)	intercambio global Internet
glacial	glacial
glacier	glaciar
glad	alegre
gladden (to -)	alegrar
glade	claro (de bosque)
gladiator	gladiador
gladly	alegremente
gladness	alegría
...
gland	glándula
glandular	glandular
glare-free screen	pantalla antireflectante
glare	reflejo (de la pantalla)
glare (to -)	deslumbrar
glaring	brillante
glass	copa
glasses	gafas
...
glider	planeador
glide (to -)	deslizarse
glimmer (to -)	brillar tenuemente
glimpse (to -)	vislumbrar
glint	brillo
...
godson	ahijado
gofer	recadero
goggle	mirar con los ojos desorbitados
going	ida
goings-on	ocurrencias
goiter	bocio
gold bream	dorada
gold bream	sama de pluma
golden carpet shell clam almeja margarita	almeja fina
golden	dorado
golden mullet	galupe
goldfinch	jilguero
goldfish	carpa dorada
gold lined bream	salema
goldline	salema
gold	oro
gold sea-bram	zapata
gold sea-bream	sama de pluma
...
gorse	tojo
gory	ensangrentado
GOSIP (abbr. for Government OSI Profile)	perfil gubernamental OSI
GOSIP-A	GOSIP de aplicaciones
GOSIP-C	GOSIP de caracteres
GOSIP-F	GOSIP de formatos
GOSIP-S	GOSIP varios
GOSIP-T	GOSIP de transporte
gosling	ansarón
gospel	evangelio
gossamer	telaraña
gossip	cotilleo
...
government	gobierno
Government OSI Profile	perfil gubernamental OSI
governor-general	gobernador general
governor	gobernador
governorship	gobierno
govern (to -)	gobernar
gown	vestido
grab (to -)	agarrar
graceful	elegante
...
gramme (UK)	gramo
gram-negative	tinción de Gram negativa
...
granulate (to -)	granular
granulation	granulación
granule	gránulo
grape (color)	uva (color)
grapefruit	toronja
grapeshot	metralla
grape stone oil	aceite de pepita de uva
grapevine	vid
graph	gráfica
...
graze	rozamiento
grazing cattle	ganado de pasto
grease	grasa
greasy	grasiento
Great Britain	Gran Bretaña
greater forkbeard	brotola de roca
...
greenish	verdoso
green lobster	langosta real
green lobster	langosta verde
green pickled olives	aceitunas para la conserva en verde
green shore crab	cangrejo verde
greens	verduras
greensward	césped
green table olives	aceitunas de mesa
green	verde (color)
Greenwich	Greenwich
green wrasse	bodión verde
green wrasse	maragota
greeting	saludo
greet (to -)	saludar
gregarious	gregario
grenade	granada
grenadier	granadero
grenadine	granadina
grey gurnard	borracho
greyhound	galgo
greyling	umbra
grey trout	trucha de lago
griddle	plancha
gridiron (US)	campo de fútbol
grid	reja
grid	rejilla
grief	pesar
...
grocer	tendero (de comestibles)
grocery store	tienda de comestibles
grocery	tienda de comestibles
groggy	vacilante
grog	ron con agua
groin	ingle
groom	mozo de caballos
groom	novio
grooved carpet shell clam almeja fina	almeja fina
grope (to -)	tentar
gross	doce docenas
...
gruff	rudo
grumbler	refunfuñón
grumble (to -)	refunfuñar
grumpy	gruñon
grumpy	gruñón
grumpy	malhumorado
grunt	gruñido
GSM (abbr. for global system for mobile communication)	GSM (abrev. inglesa de sistema global para comunicaciones móviles)
Guam	Guam
guano	guano
guarantee	garantía
guarantor	garante
...
guest	huésped
guffaw	risotada
GUI (abbr. for grafical user interface)	GUI (abrev. inglesa de interfaz gráfico de usuario)
guidance	guía
guide	guía
guideline	directriz
...
guiltless	inocente
guilty	culpable
guinea	guinea (antigua moneda inglesa)
guise	guisa
guitar	guitarra
...
hack (to -)	cortar (con hacha o con machete)
hack (to -)	piratear
haddock	abadejo
haddock	eglefino
haematoma	hematoma
...
hammering	martilleo
hammer	martillo
hammer (to -)	martillear
hammock	hamaca
hamper	cesta
hamper (to -)	complicarse
hamper (to -)	enredarse
...
hang (to -)	colgar
hangup	tara
hang up (to -)	finalizar la sesión
hankering	ansia
hanker (to -)	ansiar
hank	madeja
Hanover	Hannóver
Hansen's disease	lepra
haphazard	casualidad
hapless	desgraciado
...
harbinger	heraldo
harbor	puerto
hard clam	escupiña grabada
hard disk	disco duro
hard	duro
harden (to -)	endurecer
hard-headed	terco
hard-hearted	insensible
hardiness	vigor
hardly	apenas
hardness	dureza
hardship	penalidad
...
haunch	cadera
haunt	guarida
haunting	persistente
have a cold (to -)	estar constipado
haven	asilo
haversack	mochila
Haver's ducts	conductos de Haver
have (to -)	tener
havoc	estrago
Hawaii	Hawai
hawker	halconero
...
hawthorn	espino
haycock	almiar
hay feber	fiebre del heno
hayfield	henar
hay	heno
hayloft	henil
haymaking	siega del heno
hayrick	almiar
haystack	almiar
...
haze	niebla
hazy	neblinoso
HDLC (abbr. for high-level data link control)	control de enlace de datos de alto nivel
HDSL (abbr. for high bit rate digital subscriber line)	línea digital de abonado de alta velocidad.
headache	dolor de cabeza
headband	cinta de pelo
headband	venda para cabeza
headboard	cabecero (de la cama)
head	cabeza
head cellarman	bodeguero
head-cleaning device	dispositivo de limpieza de cabezales
...
headless	acéfalo
headlight	faro
headline	titulares (plural)
headlong	precipitado
...
headstrong	cabezudo
headwaters (plural)	fuentes de un río (plural)
headway	avance
...
heartfelt	cordial
heart frequency	frecuencia cardíaca
hearth	hogar
...
hebephrenic schizophrenia	esquizofrenia hebefrénica
Hebrew	hebreo
heckle	interrumpir con preguntas molestas
hectare	hectárea
hectic	agitado
hectic fever	fiebre hética
hedgehog	erizo
hedge	seto vivo
hedonism	hedonismo
heed	atención
...
hexagon	hexágono
hey	eh
hialinous cartilagenous tissue	tejido cartilaginoso hialino
hiatus	hiato
...
hidden	escondido
hidden	oculto
hide-and-seek	escondite ( juego del -)
...
hierarchical network	red jerárquica
hierarchy	jerarquía
...
high end of a range	parte superior de una gama
...
high resolution	alta definición
high resolution	alta resolucion
...
hospitalize (to -)	hospitalizar
host address	dirección Internet
hostage	rehén
host	anfitrión
hostel	posada
hostelry	posada
...
host	posadero
host	servidor
host system	sistema central (en Internet)
host (to -)	alojar
hotbed	estercolero
hot	caliente
hot	calor
...
housekeeping	operaciones de verificación
housemaid	criada
...
HPFS (abbr. for high performance file system)	sistema de archivos de alto rendimiento
HTML (abbr. for Hypertext Markup Language)	HTML (abrev. inglesa de lenguaje de marcado de hipertexto)
HTTP (abbr. for hypertext transmission protocol)	HTTP (abrev. inglesa de protocolo de transmisión de hipertexto)
hubbub	alboroto
hub	cubo (de una rueda)
hucho	salmón de danubio
huddle	montón
hue	tinte
hue	tonalidad
huff	enojo
...
humbug	farsa
humdrum	aburrido
humerous head	cabeza del húmero
humerous	húmero
humerus	húmero
humid	húmedo
humidifier	humectador
humidify (to -)	humedecer
humidity	humedad
humiliate (to -)	humillar
...
hypnotize (to -)	hipnotizar
hypoactivity	hipoactividad
...
hysteria	histeria
hysteria	mitoplastia
hysterical	histérico
hysterics	ataque de nervios
Hz (abbr. for hertz)	Hz (abrev. de hercio)
IAB (abbr. for Internet Architecture Board)	IAB (abrev. inglesa de Comité de Arquitectura de Internet)
iambic	yámbico
IANA (abbr. for Internet Assigned Number Authority)	IANA (abrev. inglesa de Autoridad de asignación de números en Internet)
iatrogenic	yatrogénico
Iberian Cordillera	Sistema Ibérico
ice axe	piolet
iceberg	iceberg
icebox	nevera
...
ICMP (abbr. for Internet control message protocol)	protocolo de Internet de control de mensajes
icon	icono
iconoclast	iconoclasta
icterus	ictericia
ictus epilepticus	ataque de epilepsia
ICU (abbrev. for intensive care unit)	UCI (abrev. de unidad de cuidados intensivos)
ICU (abbrev. for intensive care unit)	UVI (abrev. de unidad de vigilancia intensiva)
icy	helado
id (abbr. for identification)	identificación
ID (abbr. for identity)	identidad
Idaho	Idaho
idea	idea
ideal	ideal
idealism	idealismo
...
idyllic	idílico
idyll	idilio
IEEE (abbr. for Institute of Electrical and Electronics Engineers)	IEEE (abrev. inglesa de Instituto de Ingenieros Eléctricos y Electrónicos)
igneous	ígneo
ignite (to -)	encender
ignition	ignición
ignoble	innoble
...
imbibe (to -)	embeber
IMHO (abbr. for in my humble opinion)	en mi humilde opinión
imitate (to -)	imitar
imitation	imitación
...
infield	cuadro interior (de jugadores de béisbol)
...
influenza	gripe
influx	entrada
info (abbr. for information)	información
infoaddict	infoadicto
informal	informal
...
Internet	Internet
Internet number	número Internet
Internet phone	telefonía por Internet
...
intersticial nephritis	nefritis intersticial
inter (to -)	enterrar
...
iota	jota
Iowa	Iowa
IP (abbr. for Internet Protocol)	IP (abrev. inglesa de protocolo Internet)
IP (abbr. for Internet Protocol)	IP (abrev. inglesa de Protocolo Internet)
IP address	dirección IP
IP number	número IP
IPX (abbr. for Internet packet exchange)	intercambio de paquetes en Internet
Iran	Irán
Iraq	Irak
irascible	irascible
irate	airado
IRC (abbr. for Internet relay chat)	IRC (abrev. inglesa de charla interactiva Internet)
ire	ira
Ireland	Irlanda
...
ironworks	herrería
irony	ironía
IRQ (abbr. for interrupt request)	IRQ (abrev. inglesa de petición de interrupción)
...
isle	isla
islet	isleta
ISO (abbr. for International Standards Organization)	ISO (abrev. inglesa de Organización Internacional de Estándars)
ISO (abbr. for International Standards Organization)	ISO (abrev. inglesa de Organización Internacional para la Normalización)
isobar	isobara
isolate (to -)	aislar
...
isotherm	isoterma
isotope	isótopo
ISP (abbr. for Internet service provider)	proveedor de servicios Internet
isquium	isquión
Israeli	israelí
Israel	Israel
ISS (abbr. for Internet security scanner)	rastreador de seguridad de Internet
issue	cuestión
issued	emitido
issue	emisión
issues	cuestiones
...
jackpot	premio máximo (de una máquina tragaperras)
jackstraw	pajita
jaded	agotado
jade	jade
jag	diente
jagged	dentado
jaggies	irregularidades (en los trazos)
jaguar	jaguar
jailbird	presidiario
jailbird	preso
jailbird	reincidente
...
jam in paper feed	atasco en el suministro de papel
...
jetlag	desorientación después de un viaje largo en avión)
jetsam	echazón
jettison (to -)	echar
jetty	malecón
jeweler (US)	joyero
...
KB (abbr. for kilobyte)	KB (abrev. de kilobyte)
kbps (abbr. for kilobits per second)	kbps (abrev. de kilobits por segundo)
keel	quilla
keen	entusiasmo
keenness	agudeza
keen	perspicaz
...
key punch	perforadora (de tarjetas)
keystone	clave
key-to-disk computer	ordenador de entrada directa de datos
...
knee	rodilla
knell (to -)	tocar a muerto (las campanas)
knife	cuchillo
knight	caballero
...
lamp	lámpara
lampoon	pasquín
LAN (abbr. for local area network)	LAN (abrev. inglesa de red de área local)
lance	lanza
lance	lanzón
...
lapel	solapa
lap	faldón
LAPM (abbr. for link access procedure for modems)	procedimiento de acceso a enlace para módems
lapse	lapso
laptop	laptop
...
launch	lanzamiento
launch program	lanzadera (programa -)
...
lay (to -)	poner
lazy	perezoso
LCP (abbr. for link control protocol)	protocolo de control de enlace
LDAP (abbr. for light directory access protocol)	protocolo de acceso a directorio ligeros
...
line conditioning	acondicionamiento de la línea
line	cordel
lined	rayado
line	fila
line	hilo
...
line surge	subida de tensión
line surge	subida de tensión de alimentación
linfa	lymph
ling	arbitán
...
liniment	linimento
lining	forro
linkage editor	editor de enlaces
linkage	unión
link	enlace (en documentos HTML)
linker	editor de enlaces
link	eslabón
link (to -)	enlazar
linoleum	linóleo
linseed	linaza
...
listless	apático
list	lista
list server	servidor de listas (en Internet)
list (to -)	listar
litany	letanía
...
lizard	lagarto
llama	llama
LLC (abbr. for link level control)	nivel de enlace lógico
load	carga
loaded	cargado
loading	carga
load (to -)	cargar
...
lobar pneumonia	neumonía lobular
lobby	antecámara
...
logged	anotado
logger	hachero
logical branching	bifurcación lógica
...
lone	solo
lonesome	solitario
long distance phone call	conferencia (telefónica)
longevity	longevidad
long-finned grey mullet galupe	salmonete
...
loyalty	lealtad
lozenge	rombo
LPI (abbr. for lines per inch)	LPI (abrev. inglesa de líneas por pulgada)
LQ (abbr. for letter quality)	calidad carta
LU (abbr. for logical unit)	unidad lógica
...
lyricism	lirismo
lyric	letra
mA (abbr. for milliampere)	mA (abrev. de miliamperio)
MAC (abbr. for media access control)	control de acceso al medio
macabre	macabro
...
mailing list	lista de distribución (de correo electrónico)
mailing	mailing
mailman	cartero
...
mainframe	servidor corporativo
mainland	continente
...
mammoth	gigantesco
mammy	mamaíta
MAN (abbr. for metropolitan area network)	MAN (abrev. inglesa de red de área metropolitana)
...
many	muchos
MAP (abbr. for manufacturing automation protocol)	protocolo de fabricación automatizada
map	correspondencia
map	mapa
mapping	cartografía
map (to -)	asignar
...
mash	masa
maskable interrupts	interrupciones enmascarables
masked	enmascarado
mask	máscara
...
mature (to -)	madurar
maturity	madurez
MAU (abbr. for medium attachment unit)	UAM (abrev. de unidad de acceso multiestación)
maul	mazo
mausoleum	mausoleo
maximal	máximo
maximize	maximizar
...
may (to -)	poder
maze	laberinto
Mb (abbr. for megabit)	Mb (abrev. de megabit)
MB (abbr. for megabyte)	MB (abrev. de megabyte)
mbone	red troncal multimedia
mbps (abbr. for megabits per second)	mbps (abrev. de megabits por segundo)
mead	aguamiel
meadow	pasto
meadow	prado
meager	magro
...
mentor	mentor
menu	carta
menu-driven software	programa gobernado por menús
menu	menú
meow	maullido
...
MFLOPS	MFLOPS (millones de operaciones en coma flotante por segundo)
MHS (abbr. for message handling system)	sistema de manejo de ficheros
MHz (abbr. for megahertz)	MHz (abrev. de megahercio)
Miami	Miami
miaow	maullido
MIB (abbr. for management information base)	base de información de gestión
...
MIME (abbr. for multipurpose Internet mail extensions)	MIME (abrev. inglesa de extensiones multiusos del correo Internet)
mime	mímica
mime	mimo
mimic	imitador
mimicry	imitación
min (abbr. for minimum)	mínimo
minaret	alminar
...
minutiae	minucias
minx	bribona
MIPS (abbr. for million of instructions per second)	millón de instrucciones por segundo
miracle	milagro
...
misconstrue (to -)	interpretar equivocadamente
miscount	error de cuenta
misdeed	fechoría
misdemeanor	delito menor
misdemeanor	infracción
misdirect (to -)	dirigir equivocadamente
...
mismanage (to -)	administrar mal
mismatch	falta de coincidencia
...
misuse	mal uso
MIT (abbr. for Massachusetts Institute of Technology)	Instituto Tecnológico de Massachusetts
mite	óbolo
mitigate (to -)	mitigar
mitigation	mitigación
mitosis	mitosis
mitotic division	división mitotica
mitotic division	división mitótica
mitral	mitral
mitral stenosis	estenosis mitral
mitral valvulopastry	valvuloplastia mitral
mitten	mitón
mitt	mitón
mix	mezcla
mix (to -)	combinar
mixture	mezcla
mix-up	confusión
MLT (abbr. for multiple logical terminal)	terminal de lógica múltiple
MMX (abbr. for multimedia extensions)	extensiones multimedia
mnemonic	código mnemotécnico
mnemonic	mnemotécnico
mnemonic	nemónico
mnemonic	nemotécnico
mnemonics	regla mnemotécnica
MNP (abbr. for Microcom Networking Protocol)	MNP (abrev. inglesa de protocolo de redes de Microcom)
moan	gemido
moat	foso
mob	chusma
mobile	móvil
...
model	modelo
mode	modo
moderated mailing-list	lista de distribución con moderador (de correo electrónico)
...
Most Valuable Player	mejor jugador (el -)
motel	motel
...
mown (to -)	cortar
mown (to -)	segar
mow (to -)	cortar (el césped)
Mozarab	mozárabe
Mr	Sr.
Mrs	Sra.
MRU (abbr. for maximum receive unit)	unidad máxima de recepción
Ms	Sra. o Srta.
MTU (abbr. for maximum transmission unit)	unidad de máxima transmisión
much	mucho
much	muchos
mucilage	mucílago
muck	estiércol
...
multipoint line	línea multipunto
...
mutual	mutuo
muzzle	hocico
MVP (abbr. for Most Valuable Player)	mejor jugador (el -)
my	mi
...
name (to -)	nombrar
nanny	niñera
nanosecond	nanosegundo (unidad equivalente a 1/1.000.000.000 segundo)
NAP (abbr. for network access point)	punto de acceso a la red
nape	nuca
naphtha	nafta
napkin	servilleta
nap	siesta
...
nay	no
Nazi	nazi
NC (abbr. for network computer)	ordenador de red
NCP (abbr. for network control protocol)	protocolo de control de red
NCSA (abbr. for National Center for Supercomputing Applications)	NCSA (abrev. inglesa de Centro Nacional de Aplicaciones de Supercomputación)
nearby	cercano
near	cerca
near letter quality	calidad tipo carta (casi)
nearly	casi
nearness	proximidad
...
nervy	excitable
nested loops (plural)	bucles anidados (plural)
nestle (to -)	anidar
nest	nido
NetBEUI (abbr. for NetBIOS extended user interface)	NetBIOS en modo protegido
NetBIOS (abbr. for network BIOS)	sistema básico de E/S de red
Netherlands (the -)	Países Bajos (los -)
netiquette	etiqueta de Internet
netizen	ciudadano de la red
netizen	ciuredano
net	neto
net	red
net runner	cibernauta
net surfing	navegación por la red
nettle (to -)	irritar
...
newsgroup	grupo de interés (plural)
newsletter	boletín
...
nibble	mordisco
NIC (abbr. for Network Information Center)	Centro de Información de Redes
Nicaragua	Nicaragua
...
nimble	ágil
nimbleness	agilidad
NiMH	hidruro metálico de niquel
...
nitwit	simple
NLQ (abbr. for near letter quality)	calidad tipo carta
Nm (abbr. for newtonmeter)	Nm (abrev. de newtónmetro)
Noah	Noé
nobility	nobleza
nobleman	noble
nobleness	nobleza
...
north	norte
North Rhine-Westphalia	Renania Septentrional-Westfalia
...
notary	notario
not at all	absoluto
notational conventions	convenciones de notación
notation	anotación
notch	corte
notch	muesca
notch	orificio
...
nozzle	boquilla
nozzle	tobera
ns (abbr. for nanosecond)	ns (abrev. de nanosegundo)
nuance	matiz
nuclear	nuclear
nucleus	núcleo
nude	desnudo
...
nullify (to -)	anular
null	nulo
number cruncher	calculadora
number crunching	calculo en masa
numbering method	método de numeración
numbering method	método numérico
...
numeric	numérico
numeric variable	variable numérica
numerous	numeroso
nun	monja
nunnery	convento
nuptial	nupcial
...
oedema	edema
OEM (abbr. for original equipment manufacturer)	OEM (abrev. inglesa de fabricante de equipo original)
oesophagus	esófago
of course	claro
...
olive	aceituna
olive cultivation	olivicultura
olive grove	olivar
...
once	una vez
on-demand report	informe sobre petición
on	en
on	encendido
one	uno
ongoing	continuado
...
onset	principio
on-site	in situ
on-site maintenance	mantenimiento en la propia instalación
onslaught	asalto
onto	encima de
onward	adelante
onyx	ónix
OOP (abbr. for object oriented programming)	POO (abrev. de programación orientada a objetos)
ooze (to -)	rezumar
oozy	legamoso
opacity	opacidad
opal	ópalo
...
open	abierto
open-air	intemperie
open-ended system	sistema abierto
opener	abridor
opening	abertura
openly	abiertamente
open	abrir
...
orphanage	orfandad
orphan	huérfano
orphan line	línea sola (parte superior de la hoja)
orthodox	ortodoxo
orthodoxy	ortodoxia
orthographic	ortográfico
orthopaedic (UK)	ortopédico
orthopedic (US)	ortopédico
OS (abbr. for operating system)	SO (abrev. de sistema operativo)
oscillate (to -)	oscilar
oscillation	oscilación
oscillator	oscilador
OSI (abbr. for open system interconnection)	MARISA (abrev. de Modelo Arquitectónico de Referencia para la Interconexión de Sistemas Abiertos)
OSI (abbr. for open system interconnection)	MARISA (abrev. de Modelo Arquitectonico de Sistemas Abiertos)
OSI (abbr. for Open Systems Interconnection)	OSI (abrev. inglesa de interconexión de sistemas abiertos)
Oslo	Oslo
osmosis	ósmosis
...
oyster	ostra
ozone	ozono
PABX (abbr. for private automatic branch exchange)	centralita telefónica
pacemaker	marcapasos
pace	paso
pacification	pacificación
Pacific Ocean	Océano Pacífico (el -)
pacific	pacífico
...
page make-up program	programa compositor de páginas
page	página
pager	buscapersonas
pagoda	pagoda
paid	pagado
...
pamper (to -)	mimar
pamphlet	folleto
PAN (abbr. for personal area network)	PAN (abrev. inglesa de red de área personal)
panacea	panacea
...
Paraguay	Paraguay
parakeet	perico
parallel interface	interfase en paralelo
...
parameter	parámetro
paramount	superior
paranasal sinus	seno paranasal
paranoia	paranoia
...
parser	intérprete
parses	interpreta
parser	programa analizador sintáctico
...
paste	pasta
pastern	cuartilla
paste up board	tablero de composición
...
pasturage	pasto
pasture	pasto
patch a program (to -)	parchear un programa
patch	parche
patchy	remendado
patented	patentado
patent	patente
...
pattern	patrón
pattern	pauta
patter (to -)	andar con pasos ligeros
patty	pastelillo
paunch	barriga
pauper	pobre
pause	pausa
...
PC (abbr. for personal computer)	ordenador personal
pct (abbr. for)	porcentaje
PDP (abbr. for plasma display panel)	pantalla de plasma
PDU (abbr. for protocol data unit)	unidad de protocolo de datos
peaceable	pacífico
peacefulness	calma
peaceful	pacífico
...
pelvis	pelvis
PEM (abbr. for private enhanced mail)	correo privado mejorado
...
pharmacy	farmacia
pharynx	faringe
phase-contrast microscope	microscopio de contraste de fases
phase	fase
pheasant	faisán
...
phrase	frase
phreaker (abbr. for phone hacker)	hacker telefónico
...
picking device	dispositivo de selección
pickle	encurtido
pickling	aderezo
pickpocket	ratero
pick (to -)	recoger
...
pig	cerdo
pigeon	paloma
piggyback board	tarjeta superponible
...
pillion	asiento trasero (de una motocicleta)
pillow	almohada
...
pineapple	piña
pine	pino
PING (abbr. for packet Internet groper)	PING (abrev. inglesa de búsqueda de direcciones de Internet)
...
plain bonito	melva
plain bonito	tasarte
plain	llano
plain muscle	músculo liso
plainness	llanura
plain	simple
plaintive	lastimero
plait	rizo
...
poet	poeta
poetry	poesía
pogrom	persecucion antisemita
pointcasting	difusión punto a punto
pointed	puntiagudo
pointer	indicador
pointless	vano
point	punto
...
poorly	pobremente
poor	pobre
POP (abbr. for post office protocol)	POP (abrev. inglesa de protocolo de oficina de correos, en Internet)
...
porous osseous tissue	tejido óseo esponjoso
porous	poroso
porpoise	marsopa
...
pout	mala cara.
pout	puchero
pout (to -)	decir con mala cara
poverty	miseria
poverty	pobreza
powder	polvo
powdery	polvoriento
power failure	fallo en la alimentación electrica
power failure	fallo en la alimentación eléctrica
power	fuerza
powerful	poderoso
powerless	impotente
power management	gestión de energía
power management	gestor de potencia
power off	apagado
power on	encendido
power	poder
power	potencia
power (to -)	alimentar
PPP (abbr. for point-to-point protocol)	PPP (abrev. inglesa de protocolo punto a punto)
...
primary	primero
primary	principal
primary selection	selección primaria
primate (to -)	primar
prime	primero
primer	cebador
primeval	prístino
...
ptomaine	tomaína
PU (abbr. for physical unit)	unidad física
puberty	pubertad
pubes	pubis
pubic	púbico
...
public domain software	proramas de dominio publico
...
pullover	jersey
pull (to -)	tirar
pull tractor	alimentador de tracción
pulmonary abscess	absceso pulmonar
pulmonary biopsy	biopsia pulmonar
pulmonary	pulmonar
pulpit	púlpito
pulp	pulpa
pulsar	púlsar
...
purity	pureza (de color)
purple dye murex	púrpura
purple	púrpura (color)
purport	significado
...
pursuit	persecución
pushcart	carretilla
push-down list	lista descendente
push	empujón
pusher	arribista
push media	medios no-interactivos
push (to -)	empujar
push tractor	alimentador de fricción
push-up list	lista ascendente
pus	pus
puss	gato
pussy	gato
pustule	pústula
put down (to -)	colgar (# teléfono)
puting	faneca
...
put (to -)	poner
putty	masilla
put up with (to -)	soportar
puzzle	enigma
puzzlement	perplejidad
PVC (abbr. for permanent virtual circuit)	circuito virtual permanente
pygmy	pigmeo
pylon	pilón
pylorous	píloro
pyramidal	piramidal
pyramid	pirámide
Pyrenees	Pirineos (los -)
pyre	pira
pyrophosphato	pirofosfato
pyrotechnics	pirotecnia
python	pitón
QAM (abbr. for quadrature amplitude modulation)	modulación de amplitud en cuadratura
QBE (abbr. for query by example)	consulta según ejemplo
QM (abbr. for queue manager)	gestor de colas
QTM (abbr. for queue telecomunications access method)	metodología de acceso de colas en sistemas de telecomunicaciones
qty (abbr. for quantity)	cantidad
...
quaff (to)	beber a grandes tragos
quagmire	ciénaga
quail	codorniz
quaint	pintoresco
...
quarry	(animal) presa del depredador
quarry	cantera
...
quilt	colcha
quilted	acolchado
quilted waistcoat	chaleco acolchado
quilting	acolchado
...
randomize (to -)	dar carácter aleatorio
randomly	al azar
...
razor shell	navaja
r	carcelero
RD (abbr. for receive data)	RD (abrev. de recepción de datos)
...
rebuttal	refutación
rebut (to -)	refutar
recalcification	recalcificación
...
reloading	recarga
reload	recargar
relocatable program	programa reubicable
...
remedial maintenance	mantenimiento correctivo
...
removable (unit)	extraible (unidad -)
removal	mudanza
remove (to -)	borrar
remove (to -)	eliminar
remove (to -)	quitar
...
respiratory track	sistema respiratorio
respiratory track	vía respiratoria
respiratory tract	aparato respiratorio
respire (to -)	respirar
respite	tregua
...
retrofit a system (to -)	actualizar un sistema
retrogade amnesia	amnesia retrógrada
...
reweigh (to -)	repesar
rewind (to -)	rebobinar
reword (to -)	redactar de nuevo
Reykjavik	Reikiavik
RFC (abbr. for request for comment)	petición de comentarios
rhapsody	rapsodia
rhetorical	retórico
rhetoric	retórica
rheumatic	reumático
...
rhythmic	rítmico
rhythm	ritmo
RI (abbr. for ring indicator)	indicador de llamada
ribald	grosero
ribaldry	obscenidad
ribbing	costillaje
ribbon	cinta
...
rock	piedra
rocky	rocoso
roco scanning (abbr. for row-column scanning)	exploración de líneas
rod	barra
rodent	roedor
rodeo	rodeo
rogue	pícaro
...
rolling	rodante
roll in (to -)	transferir dentro (de memora auxiliar a principal)
roll out (to -)	transferir fuera (de memoria principal a auxiliar)
roll	rollo
romable	grabable en ROM
romance	romance
Romania	Rumania
Roman	romano
romantic	romántico
...
rugby	rugby
rugged	escabroso
ruggedized computer	ordenador resistente
...
ruling	gobernante
Rumanian	rumano
rumble (to -)	decir con voz cavernosa
ruminant	rumiante
ruminate (to -)	rumiar
...
SAP (abbr. for service access point)	punto de acceso al servicio
sapling	arbolillo
sapper	zapador
sap	savia
Saragossa	Zaragoza
...
sartorial	sartorio
SASE (abbr. for specific applications service elements)	elementos de aplicaciones de servicios especificos
SASE (abbr. for specific applications service elements)	elementos de aplicaciones de servicios específicos
sash	faja
sat (abbr. for Saturday)	sábado
Satanic	satánico
Satan	Satanás
satchel	maletín
satellite	satélite
...
scanner	escáner
scanning	exploración (por barrido)
scan (to -)	escanear
scan (to -)	examinar
scan (to -)	explorar
scant (to -)	escatimar
...
scattered	disperso
scatter graph	gráfico disperso
scattering	dispersión
scattering	esparcido
scatter (to -)	esparcir
scavenger	basurero
scavenge (to -)	recoger la basura
scenario	contexto
scenario	escenario
scene	escena
scenery	paisaje
...
scheduled report	informe periódico
schedule	horario
schedule	programa
...
scream (to -)	gritar
screech	chillido
screened data	datos filtrados
screen	filtro
screen grid	retícula de la pantalla
...
scuttle	escotillón
scythe	guadaña
SD (abbr. for start delimiter)	inicio de la trama
SDLC (abbr. for synchronous data link controller)	controlador de enlace de datos síncrono
SDU (abbr. for service data unit)	unidad de datos de servicio
seabed	lecho marino
seabird	albatros
seaboard	litoral
sea-bream	boga
...
sea-wolf	lubina
seaworthy	marinero
SEC (abbr. for single edge connect)	conexión de una sola línea
secede (to -)	separarse
secession	secesión
seclude (to -)	recluir
...
see chapter	ver capítulo
seed (corn)	semilla
seed (corn)	simiente
seed	grano
seed-harrow	sembradora
seedling	arbolillo
seedy	granado
seeing	vista
seeker	buscador
...
seemly	decente
seem (to -)	parecer
SEEP (abbr. for secure electronic payment protocol)	SEEP (abrev. inglesa de protocolo de pago electrónico seguro)
seep (to -)	rezumarse
seer	vidente
...
sequel	secuela
sequence	sucesión
sequential file	fichero de acceso secuencial
...
sergeant	sargento
serial	en serie
serial interface	interface en serie
...
set (to -)	establecer
setup	arreglo
setup program	programa de instalación
seven	siete
...
sexual	sexual
sexy	sexual
SG (abbr. for signal ground)	tierra de sen
SG (abbr. for signal ground)	tierra de señalización
SGML (abbr. for Standardized Generalized Markup Language)	SGML (abrev. inglesa de lenguaje estandarizado y generalizado de marcado)
shabby	gastado
shack	choza
shackle	grillete
shaded	sombreado
...
shareware	programas de libre evaluación
shark	tiburón
sharp	afilado
sharp	agudo
sharpener	afilador
...
sheik	jeque
shelf	estante
shelfware	programas de estantería (maula)
shellac	goma laca
shell	cáscara
shell	concha
shellfish	marisco
...
showbiz	mundo del espectáculo (FAM)
shower	ducha
showery	lluvioso
showing	exhibición
showman	artista
...
siddle (to - up)	acercarse sigilosamente
siddle (to - up)	servilmente
sideboard	aparador
sideburn	patilla
...
sightseer	turista
sight	vista
signaling system	sistema de sen
...
simple bronchitis	bronquitis simple
simple-minded	tonto
simple schizophrenia	esquizofrenia simple
simple	sencillo
simpleton	simplón
simpleton	tonto
...
singer	cantante
singer	cantor
single	individual (habitación -)
single room	habitación sencilla
single	simple
singles	individuales (partidos -)
single	solo
single	soltero
singleton	única carta de un palo en el bridge
single	único
...
sinless	puro
sinner	pecador
sinovial liquid	líquido sinovial
sinovial membrane	membrana sinovial
sin	pecado
sinuous	sinuoso
sinusitis	sinusitis
sinus	seno
...
skillet	cacerola de mango largo
skillet	sarten
skillful	hábil
skill	habilidad (conocimiento practico)
...
sky rocket (to -)	ponerse por las nubes
sky rocket (to -)	ponerse por las nubes (FAM)
...
sling (to -, sling ,slung, slung)	lanzar
sling (to -, sling ,slung, slung)	tirar
slink (to -)	entrar furtivamente
SLIP (abbr. for serial line IP)	SLIP (abrev. inglesa de línea serie IP)
...
slothful	perezoso
sloth	pereza
slot (table -)	casilla (de una tabla)
...
sly	furtivo
smack	bofetada
SMAEs (abbr. for system management application entity)	entidad de aplicación
SMAEs (abbr. for system management application entity)	entidad de aplicación de gestión
...
smote (to -, smote, smite, smitten)	castigar
smote (to -, smote, smite, smitten)	doler
smote (to -, smote, smite, smitten)	golpear
smote (to -, smote, smite, smitten)	herir
smother	humareda
SMP	sistema de multiproceso simétrico
SMTP (abbr. for Simple Mail Transfer Protocol)	SMTP (abrev. inglesa de protocolo simple de administración de redes)
SMTP (abbr. for Simple Mail Transfer Protocol)	SMTP (abrev. inglesa de protocolo simple de transferencia de correo)
smudge	mancha
smug	autosuficiente (despectivo)
...
smut	obscenidad
smutty	tiznado
SNA (abbr. for system network architecture)	arquitectura de redes
snack	bocado
snag	tocón
snail	caracol
snail mail	correo normal (despectivo, por contraposición al electrónico)
snake	serpiente
snap	chasquido
snappy	rápido
...
snipe (to -)	tirar
snip	tijeretazo
SNMP (abbr. for simple network management protocol)	protocolo simple de administracion de redes
SNMP (abbr. for simple network management protocol)	protocolo simple de administración de redes
snobbery	esnobismo
snob	esnob
snooze	cabezada
snore	ronquido
...
softly	suavemente
software developer	desarrollador de programas
software piracy	piratería de programas
software	programa
software vaccine	vacuna para los programas
soggy	empapado
soil	tierra
soil (to -)	ensuciar
sojourn	estancia
...
soviet	sóviet
Soviet	soviético
Soviet Union (the -)	Unión Sovietica (la -)
...
span	ojo (luz, arcada) del puente o de un arco
span	palmo
spare	repuesto
sparing	económico
spark	chispa
...
specifications (pl)	características técnicas (pl)
specifications (plural)	características (plural)
specific	específico
...
spinach	espinaca
spinach	espinacas
spinal apophysis	apófisis espinosa
...
stagger	tambaleo
stagger (to -)	asombrar
stagger (to -)	consternar
stagger (to -)	tambalear
stagnant	estancado
...
standard	norma
standard	normal
stand-by	en reserva activa
standby	espera
stand-by	reserva activa (en -)
stand	caseta
standing	lugar
standing	nivel
...
start-stop transmission	transmisión arrítmica
...
start up (to -)	poner en funcionamiento
starvation	hambruna
...
stoned	drogado
stone	piedra
stonewall	emplear una táctica de cerrojo (en deportes)
stoneware	gres
stonework	obra de sillería
stools (plural)	deposiciones (plural)
stool	taburete
stoop	inclinación
stoop (to -)	rebajarse a hacer algo
stop	alto
...
store and forward (to -)	almacenar y enviar (mensajes)
storehouse	almacén
storeroom	almacén
stores	reservas
store	tienda
...
stowage	almacenaje
stow (to -)	guardar
STP (abbr. for shielded twisted pair)	par trenzado apantallado
...
string (to -, string, strung, strung)	ensartar
stringy	correoso
stripe-bellied bonito	listado
striped bream	herrera
striped mullet	salmonete de fango
striped	rayado
...
stubby	rechoncho
stub	cabo
stub network	red aislada (en Internet)
stub	resguardo
stub	talón
stucco	estuco
stuck (to -)	atrancarse
...
supertwist display	pantalla de supertorsión
...
surroundings	alrededores (plural)
surround	rodear
...
tan	bronceado
tangent	tangente
tangerine (color)	mandarina (color)
tangible	tangible
tangle	enredo
tango	tango
...
tapestry	tapiz
tape (to -)	grabar
tap into (to -)	conectar
tap into (to -)	introducir
tapioca	tapioca
tapir	tapir
tap	palmadita
tar	alquitrán
...
tax	tasa
TCP/IP (abbr. for transmission control protocol/Internet protocol)	TCP/IP (abrev. inglesa de protocolo de control de transmisión/protocolo Internet)
TD (abbr. for transmit data)	transmitir datos
teacher	maestro
teacher	profesor
teaching	enseñanza
teach (to -)	enseñar
...
telecommute (to -)	trabajar a distancia (por telecomunicación)
...
thread	flujo de ejecución
thread	hilo
thread	hilo conductor (de un relato)
thread	rosca
thread (to -)	hilvanar
threat	amenaza
...
tight	firme
tight	hermético
tightly coupled system	sistema fuertemente acoplado
...
till	hasta
tilt	inclinación
tilting screen	pantalla inclinable
timber	madera
time	vez
time	duración
time	hora
...
toxin	toxina
toy	juguete
TPS (abbr. for transactions per second)	TPS (abrev. inglesa de transacciones por segundo)
trabecula	trabécula
trace	rastro
tracer	diseñador
trace (to -)	rastrear
tracheobronchial arbor	árbol traqueobronquial
...
treadmill	rueda de molino (movida por personas)
tread	paso
tread	pisada
tread (to -)	pisar
tread (to -)	pisotear
...
trestle	caballete
triad	tríada
triage	clasificación de los heridos después del combate
...
trouble	afección
trouble	problema
troubleshooter (US)	localizador de averías
troubleshooting guide	guía para la solución de problemas
troubleshooting	procedimiento para solucionar problemas
troubleshoot	solución de problemas
troublesome	molesto
trough	pesebre
troupe	compañía teatral
trouper	miembro de una compañía teatral
trousers	pantalones
trout	trucha
trowsers crease	raya de los pantalones
trowsers	pantalones
truce	tregua
truck	camión
trudge	caminata
trudge (to -)	caminar penosamente
true	verdadero
...
try (to -)	probar
T-shirt	camiseta
TSTN (abbr. for Triple STN)	STN triple
tuba	tuba
tub	bañera
...
tubular	tubular
tuck	alforza
tue (abbr. for Tuesday)	martes
Tuesday	martes
tug	remolcador
tuition	matrícula (coste de la -)
tularemia	tularemia
tulip	tulipán
tulle	tul
tumble	caída
...
tutorial	manual de aprendizaje
tutor	tutor
tuxedo	esmoquin
TV (abbr. for television)	televisión
...
twentieth	vigésimo
twenty	veinte
twerp	sujeto (you twerp!=imbécil)
twerp	tío (you twerp!=imbécil)
twice	dos veces
twiddle (to -)	jugar
twig	ramita
twilight	crepúsculo
...
twirl	giro
twisted pair cable	cable de par cruzado
twist (to -)	torcer
twitch	tirón
twit	imbécil
two	dos
...
ubrine	verrugato
udder	ubre
UDP (abbr. for user datagram protocol)	protocolo de datagramas de usuario
UG (abbr. for user group)	grupo de usuario
ugliness	fealdad
ugly	feo
U.K. (abbr. for United Kingdom)	R.U. (abrev. de Reino Unido)
Ukraine (the -)	Ucrania
ulcerous	ulceroso
ulcer	úlcera
ulna	cúbito
...
U.N. (abbr. for United Nations)	ONU (abrev. de Organización de las Naciones Unidas)
unable	incapaz
...
unbroken	irrompible
unbundled system	sistema disociable
unburden (to -)	aliviar
...
unperforated needle	aguja ciega
...
unseaworthy	sin condiciones para hacerse a la mar
...
unstable	inestable
unsteady	inseguro
unstripped muscle	músculo liso
...
up	arriba
up arrow key	tecla de flecha arriba
upbraid (to -)	regañar
...
upgradeability	posibilidad de ampliación
upgrade (to -)	actualizar
upgrade	versión revisada
upgrading	mejora
up	hacia arriba
uphold (to -)	levantar
...
upset	disgustado
upshot	resultado final
upside-down	al revés
upstage	eclipsar (un actor a otro)
upstairs	arriba
upstanding	honrado
upstart	advenedizo
uptime	tiempo de actividad (de una máquina)
upturn	mejora
upward compatible	de compatibilidad ascendente
...
urgency	urgencia
urgent	urgente
URI (abbr. for universal resource identifier)	URI (abrev. inglesa de identificador universal de recursos
URI (abbr. for universal resource identifier)	URI (abrev. inglesa de identificador universal de recursos)
...
urinate (to -)	orinar
urine	orina
URL (abbr. for universal resource locator)	URL (abrev. inglesa de localizador universal de recursos)
urn	urna
urticaria	urticaria
Uruguayan	uruguayo
Uruguay	Uruguay
USA (abbrev. for United States of America)	EE.UU. (abrev. de Estados Unidos)
usable	utilizable
usable width	ancho utilizable
usage	uso
USB (abbr. for universal serial bus)	USB (abrev. inglesa de bus de conexión en serie universal.....)
USB (abbr. for universal serial bus)	USB (abrev. inglesa de bus de conexión en serie universal)
used	usado
usefulness	utilidad
useful	útil
...
utilize (to -)	utilizar
utmost	sumo
UTP (abbr. for unshielded twisted pair)	par trenzado sin apantallar
utter	absoluto
utterance	pronunciación
utterly	absolutamente
UUCP (abbr. for Unix-to-Unix copy program)	UUCP (abrev. inglesa de protocolo de comunicaciones de Unix a Unix)
uvular	uvular
uvula	úvula
...
valuable	valioso
valuator	tasador
value added network	red de valor añadido
valueless	sin valor
valuer	tasador
value	valor
vamp	coqueta
vampire	vampiro
VAN (abbr. for value added network)	red de valor añadido
...
vastly	inmensamente
vast	vasto
VAT (abbr. for value added tax)	IVA (abrev. de impuesto sobre el valor añadido)
vat	depósito
...
ventricular septum	tabique ventricular
...
vexatious	molesto
vex (to -)	molestar
VFD (abbr. for vacuum fluorescent display)	VFD (abrev. inglesa de pantalla fluorescente de vacío)
...
videoondemand	televisión a la carta
videotape	vídeo
...
voyage	viaje
voyeur (French)	mirón
voyeur (French)	voyeur (francés)
VRAM	RAM de vídeo
VRML (abbr. for Virtual Reality Modeling Languaje)	VRML (abrev. inglesa de lenguaje de modelado de realidad virtual)
VT (abbr. for virtual terminal)	terminal virtual
...
wailing	lamentos
wail (to -)	lamentar
WAIS (abbr. for wide area information server)	WAIS (abrev. inglesa de servidores de información de área amplia)
...
walrus	morsa
waltz	vals
WAN (abbr. for wide area network)	WAN (abrev. inglesa de red de área extensa)
wanderer	vagabundo
wandering	errante
...
waste	residuo
waste substances	sustancias de desecho
waste (to -)	gastar
watchdog	perro guardián
watchdog timer	temporizador de guarda
watchful	en vela
watching	vigilancia
watchmaker	relojero
watchman	vigilante
...
website	sitio web
web (to -)	tejer
wed (abbr. for Wednesday)	miércoles
wedding	boda
wedge	cuña
wedge shell	coquina
wedlock	matrimonio
...
weever	escorpión
weft	trama
weighted code	código ponderado
...
western	occidental
west	oeste
West Pomerania	Pomerania Occidental
wet	mojado
whale	ballena
whaler	ballenero
wharf	muelle
...
white tuna	albacora (atún blanco)
...
whittle (to -)	sacar punta con el cuchillo
...
wisdom	sabiduría
wisecrack	chiste
Wise Men (plural)	Reyes Magos (plural)
wise	sabio
wish	desear
wish	deseo
wishful	deseoso
...
wizened	arrugado
wizened	seco
WMC (abbr. for warning and maintenance computer)	ordenador de aviso y mantenimiento
wobble	tambaleo
wobbly	tambaleante
woe	penas (plural)
...
wrongly	mal
wrong	mal
WRT (abbr. for with respect to)	en relación con
W (watt)	W (vatio)
WYSIWYG (abbr. for what you see is what you get)	WYSIWYG (abrev. inglesa de lo que ves es lo que obtienes)
x-axis	eje x
xenophobia	xenofobia
xiphoid appendix	apéndice xifoides
Xobject	objeto-X
x-ray	radiografía
x-ray (to -)	radiografiar
x value	ordenada
X-window system	sistema X (de ventanas)
xylophone	xilófono
yachtsman	aficionado a la navegación de recreo
yacht	yate
yak	yak
yam	batata
yam	ñame
